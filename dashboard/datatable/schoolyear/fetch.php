...
$schoolyear = new DTFunction();  		 // Create new connection by passing in your configuration array
...
$statement = $schoolyear->runQuery($query);
$statement->execute();
...
foreach($result as $row)
{
	...
	$sub_array[] = $schoolyear->check_user_level($row["lvl_ID"]);
...
$filtered_rec = $schoolyear->get_total_all_records($q);
