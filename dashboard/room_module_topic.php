  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <button type="button" class="btn btn-sm btn-success add_materials" >Add Room Files</button>
          <br><br>
...
<div class="modal fade" id="material_submit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Room Files</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>  
...
?>
        <script type="text/javascript">
          ...
          //************MODULE SCRIPT************//
            ...
            "order":[],
            "ajax":{
              url:"datatable/room_module/fetch_modules.php",
              type:"POST"
            },
            "columnDefs":[
              {
      ...
      //************MATERIAL SCRIPT************//
          ...
          var materials_dataTable = $('#material_data').DataTable({
            ...
            "order":[],
            "ajax":{
              url:"datatable/room_materials/fetch.php?room_ID="+<?php echo $this_room_ID?>,
              type:"POST"
            },
            "columnDefs":[
              {
