  ...
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h3 class="h4">Manage Module Topics & Subtopic</h3>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="submit" class="btn btn-secondary" id="submit_t">Submit</button>
      </div>
       </form>
    </div>
  </div>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="submit" class="btn btn-secondary" id="submit_tt">Submit</button>
      </div>
       </form>
    </div>
  </div>
...
<div class="modal fade" id="material_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Room Files</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <?php 
          if($auth_user->student_level()){
            ...
            ?><button type="button" class="btn btn-sm btn-success add_materials" >Add Room Files</button><?php
          }
        ...
        <script type="text/javascript">
          ...
          $(document).on('submit', '#topic_form', function(event){
             ...
             // alert(topic_title);
                ...
                url:"load1.php",
                method:'POST',
                data:{action:operation,mod_ID:<?php echo $mod_ID?>,topic_title:topic_title,topic_ID:topic_ID},
                dataType:"json",
          ...
          $(document).on('submit', '#subtopic_form', function(event){
            ...
            $('#topic_ID').val(topic_ID);
                ...
                url:"load1.php",
                method:'POST',
                data:{action:"get_topic",topic_ID:topic_ID},
                // contentType:false,
                // processData:false,   
                dataType:"json",
            ...
            var subtopic_ID = $(this).attr("sub-topic");
              ...
              $('#m_subtopic').modal("show");
                ...
                url:"load1.php",
                method:'POST',
                data:{action:"get_subtopic",submtop_ID:subtopic_ID},
                dataType:"json",
                success:function(data)
                {
            ...
            $('#submtop_ID').val(subtopicID);
                ...
                url:"load1.php",
                method:'POST',
                data:{action:"get_subtopic",submtop_ID:subtopicID},
                dataType:"json",
                success:function(data)
                {
            ...
            var subtopicID = $(this).attr("sub-topic");
             ...
             if (confirm("Are you sure you want to delete this subtopic?")) {
                  ...
                  url:"load1.php",
                  method:'POST',
                  data:{action:"delete_subtopic",subtopicID:subtopicID},
                  dataType:"json",
                  complete:function(data)
                  {
                    dataTable.ajax.reload();
          ...
          var materials_dataTable = $('#material_data').DataTable({
            ...
            "order":[],
            "ajax":{
              url:"datatable/room_materials/fetch.php?room_ID="+<?php echo $this_room_ID?>+"&mod_ID="+<?php echo $mod_ID?>,
              type:"POST"
            },
            "columnDefs":[
              {
